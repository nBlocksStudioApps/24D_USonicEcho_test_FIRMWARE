...
nBlockConnection    n_conn3( &nb_nBlockNode1_USonicEcho,   0,    &nb_nBlockNode4_StringFormat, 0);
nBlockConnection    n_conn4( &nb_nBlockNode0_Ticker,       0,    &nb_nBlockNode1_USonicEcho,   0);
